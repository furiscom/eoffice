...
(1, 'Dinas Pendidikan Pemuda Dan Olahraga', 'BADAN PENGELOLAAN DAN KEUANGAN DAN ASET DAERAH Kabupaten Muaro Jambi ', 'Terakreditasi A', 'Sawahan, Nganjuk, Jawa Timur', 'Rudi', '-', 'https://', 'email@', 'logo.png', 1);
