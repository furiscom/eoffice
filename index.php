...
<head>
    ...
    <title>E-OFFICE BPKAD KABUPATEN MUARO JAMBI</title>
    ...
    <style type="text/css">
        ...
        #BADAN PENGELOLAAN DAN KEUANGAN DAN ASET DAERAH Kabupaten Muaro Jambi {
            font-size: 2rem;
            margin-bottom: 10px;
        }
        .batas {
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">E-OFFICE BPKAD KABUPATEN MUARO JAMBI</h5>
                            <?php echo '<img id="logo" src="upload/'.$data['logo'].'">';?>
                            <h4 class="center" id="BADAN PENGELOLAAN DAN KEUANGAN DAN ASET DAERAH Kabupaten Muaro Jambi">
                            <?php echo ''.$data['nama'].'';?>
                            </h4>
                            <div class="batas"></div>
                        </div>
