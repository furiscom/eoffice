...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">web</i> BPKAD</a>
                ...
                <div class="logo-side center blue-grey darken-3">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                echo '<h5 class="BADAN PENGELOLAAN DAN KEUANGAN DAN ASET DAERAH Kabupaten Muaro Jambi-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="BADAN PENGELOLAAN DAN KEUANGAN DAN ASET DAERAH Kabupaten Muaro Jambi-side">BADAN PENGELOLAAN DAN KEUANGAN DAN ASET DAERAH Kabupaten Muaro Jambi  Al - Husna Loceret Nganjuk</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Komp. Perkantoran Bukit Cinto Kenang, Bukit Baling, Kec. Sekernan, Kabupaten Muaro Jambi, Jambi 36381</p>';
                            }
                        }
                    ?>
                </div>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="BPKAD hide-on-med-and-down"><i class="material-icons md-36">web</i> BPKAD</a></li>
            <li><div class="grs"></></li>
