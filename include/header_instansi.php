                    ...
                    <div class="card blue-grey white-text">
                        <div class="card-content">';
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="ins">BADAN PENGELOLAAN DAN KEUANGAN DAN ASET DAERAH Kabupaten Muaro Jambi AL - Husna Loceret Nganjuk</h5>';
                            }

                            if(!empty($data['alamat'])){
                                echo '<p class="almt">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="almt">Komp. Perkantoran Bukit Cinto Kenang, Bukit Baling, Kec. Sekernan, Kabupaten Muaro Jambi, Jambi 36381</p>';
                            }
                            echo '
                        </div>
                    </div>
